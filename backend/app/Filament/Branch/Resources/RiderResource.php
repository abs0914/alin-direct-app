...
use App\Filament\Branch\Resources\RiderResource\Pages;
use App\Filament\Branch\Resources\RiderResource\RelationManagers;
...
class RiderResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Riders';
