    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <View style={styles.content}>
        ...
        <TextInput
          ...
          keyboardType="number-pad" maxLength={Config.OTP_LENGTH}
          placeholder={'0'.repeat(Config.OTP_LENGTH)} placeholderTextColor={Colors.textLight}
          editable={!isLoading} textAlign="center"
        />

        <TouchableOpacity style={[styles.button, isLoading && styles.buttonDisabled]} onPress={handleVerify} disabled={isLoading || otp.length !== Config.OTP_LENGTH}>
        ...
        <View style={styles.resendRow}>
          {countdown > 0 ? (
            ...
            <TouchableOpacity onPress={handleResend}><Text style={styles.resendLink}>Resend OTP</Text></TouchableOpacity>
          )}
        </View>
